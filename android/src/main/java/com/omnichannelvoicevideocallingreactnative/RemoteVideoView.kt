...
class RemoteVideoView {
  ...
  companion object {
    private var instance: RemoteVideoView? = null;

    fun getInstance(): RemoteVideoView {
      if (this.instance == null) {
        this.instance = RemoteVideoView();
      }
  ...
  public fun setVideoScalingModeCrop(crop: Boolean) {
    Log.i("Native/RemoteVideoView/setVideoScalingModeCrop", "$crop");
